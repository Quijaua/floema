...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($data) {
        // Verifica se a estrutura do webhook está correta
        if (isset($data['object']) && $data['object'] == 'customer' && isset($data['groups'])) {
            // Itera sobre os grupos para encontrar o groupName "$groupName"
